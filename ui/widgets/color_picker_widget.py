...
class ColorPickerWidget(QWidget):
    ...
    def __init__(self, value: str = "system", parent=None):
        ...
        self.value = value if value else "system"
        self.system_selected = False
    ...
    def open_picker(self) -> None:
        ...
        if dialog.exec() and not self.system_selected:
